    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      ...
      <header className="min-h-screen flex items-center justify-center relative">
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          />
          <h1 className="text-5xl font-bold mb-4 hover:text-blue-400 transition-colors">
            Nicolas Martinico
          </h1>
          <p className="text-xl text-blue-400 mb-8">Étudiant en BTS SIO SISR</p>
          <div className="flex justify-center space-x-6">
            <a
              href="mailto:N.Martinico@outlook.com"
        ...
        <div className="container mx-auto px-4">
          <ul className="flex justify-center space-x-8 py-4">
            <li>
              <a
                href="#presentation"
                className="text-blue-400 hover:text-blue-300 transition-colors hover:scale-105 transform inline-block"
              >
                Accueil
              </a>
            </li>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="bg-gray-900 p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300">
            <p className="text-gray-300 leading-relaxed max-w-3xl">
              Je m'appelle Nicolas Martinico, né le 10 juillet 2004.
              Actuellement, je poursuis un BTS Services Informatiques aux
              Organisations (SIO), option Solutions d'Infrastructures, Systèmes
              et Réseaux (SISR). Je suis passionné par les nouvelles
              technologies et je m'intéresse tout particulièrement à
              l'administration des réseaux et à la sécurité informatique. Je
              compte poursuivre mes études en Licence et Master afin de
              développer mes connaissances en réseaux et sécurité.
            </p>
            <p className="text-gray-300 leading-relaxed max-w-3xl mt-4">
              Mon objectif à long terme est de créer ma propre entreprise
              spécialisée dans la gestion des parcs informatiques.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="bg-gray-800 p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300">
            <div className="flex flex-col md:flex-row items-center gap-8 mb-6">
              <img
                src="https://www.eliadis.com/wp-content/uploads/2024/06/Microsoft-Entra-ID.webp"
                alt="Entra ID"
                className="w-full md:w-1/3 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300"
              />
              <p className="text-gray-300 leading-relaxed">
                Dans un domaine en constante évolution, il est essentiel de
                maintenir une veille technologique active. J'utilise des outils
                comme <strong>Feedly</strong>, <strong>Twitter</strong>, et des
                forums spécialisés pour rester informé. Mon sujet de veilleAzure
                Active Directory (Azure AD, désormais appelé Entra ID) est le
                service cloud de gestion des identités et des accès de
                Microsoft. Il fournit une authentification unique et
                authentification multifactorielle pour aider les organisations à
                accéder en toute sécurité aux applications cloud et aux
                applications sur site Entra ID permet aux organisations de gérer
                les utilisateurs et les groupes. Il peut s'intégrer sur site
                Active Directory pour fournir une solution d’identité hybride.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-12">
            <div className="border-l-4 border-blue-400 pl-6 hover:border-blue-300 transition-colors">
              ...
              <p className="text-gray-300">
                Alternance en tant que technicien support niveau 1 et 2 pour mon
                BTS SIO SISR
              </p>
            </div>
            <div className="border-l-4 border-blue-400 pl-6 hover:border-blue-300 transition-colors">
            ...
            <div className="border-l-4 border-blue-400 pl-6 hover:border-blue-300 transition-colors">
              ...
              <p className="text-gray-300">
                Stages en administration système, gestion des droits NTFS,
                Active Directory, et maintenance du stock informatique
              </p>
            </div>
            <div className="border-l-4 border-blue-400 pl-6 hover:border-blue-300 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300">
              ...
              <p className="text-gray-400">
                Lycée Robert Schuman, Dugny (2020-2023)
              </p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-900 p-6 rounded-lg transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
              ...
              <p className="text-gray-300">
                Configuration de switch et routeur Cisco et Netgear
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-300">
                Windows/Linux, Gestion des droits NTFS, Active Directory
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-300">
                Installation complète de câblage réseau
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-300">
                Python, MySQL - Scripts et gestion de base de données
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-300">
                Déploiement de logiciel et administration de conformité des
                postes
              </p>
            </div>
            <div className="bg-gray-900 p-6 rounded-lg transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
              ...
              <p className="text-gray-300">
                Gestion client et compétences relationnelles
              </p>
            </div>
          </div>
        </div>
